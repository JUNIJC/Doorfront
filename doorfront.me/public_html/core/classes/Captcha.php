...
class Captcha {
    ...
    public function display() {
        ...
        echo ($this->recaptcha) ? '<div class="g-recaptcha" data-sitekey="' . $this->recaptcha_public_key . '"></div>' :'<img src="' . $this->captcha_location . '" id="captcha" /><input type="text" name="captcha" class="form-control form-control-border" />';
