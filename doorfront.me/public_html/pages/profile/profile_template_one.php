            ...
            <div class="card profile-card animated fadeIn col-md-7 border-0">
                <div class="card-body py-4 px-0 px-md-5">
                    ...
                    <div class="text-center">
                        <img src="<?= User::display_image(AVATARS_THUMBS_ROUTE . $profile_account->avatar) ?>" class="rounded-circle responsive" style="max-width: 8rem; max-height: 8rem;" alt="<?= $profile_account->name ?>">
